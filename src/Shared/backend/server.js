...
const userRoutes = require('../../Seller/backend/routes/userRoutes');
const productsRoutes = require('../../Seller/backend/routes/products');
...
// Seller Routes
app.use('/seller/auth', require('../../Seller/backend/routes/auth'));
app.use('/seller/reviews', require('../../Seller/backend/routes/reviews'));
app.use('/seller/notifications', require('../../Seller/backend/routes/notifications'));
app.use('/seller/userProfiles', require('../../Seller/backend/routes/userProfiles'));
